...
@ref aci_gap_limited_discoverable_event event. 
  ...
  * @param Advertising_Interval_Min Minimum advertising interval for undirected and low duty cycle directed
advertising.
Time = N * 0.625 msec.
  * Values:
...
WARNING: A section of the Flash memory is used by this procedure. When this section is empty, data are written inside.
This normally happens once during the lifetime of the device, when the command is executed for the first time
(unless the section is erased).
