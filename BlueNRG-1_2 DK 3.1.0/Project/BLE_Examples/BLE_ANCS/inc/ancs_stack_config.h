#ifndef _ANCS_STACK_CONFIG_H_
#define _ANCS_STACK_CONFIG_H_
...
/* Number of services requests from the ANCS demo: it is a GATT Client */
#define NUM_APP_GATT_SERVICES 0 //1

/* Number of attributes requests from the ANCS demo: it is a GATT Client*/
#define NUM_APP_GATT_ATTRIBUTES  0 //20
...
/* Number of GATT attributes needed for the ANCS demo. */
#define NUM_GATT_ATTRIBUTES     (DEFAULT_NUM_GATT_ATTRIBUTES + NUM_APP_GATT_ATTRIBUTES)

/* Number of GATT services needed for the ANCS demo. */
#define NUM_GATT_SERVICES       (DEFAULT_NUM_GATT_SERVICES + NUM_APP_GATT_SERVICES)

/* Array size for the attribte value */

#define ATT_VALUE_ARRAY_SIZE    (44) /* Only GATT & GAP default services, NUM_LINKS = 1, Device Name = ANCSdemo*/
