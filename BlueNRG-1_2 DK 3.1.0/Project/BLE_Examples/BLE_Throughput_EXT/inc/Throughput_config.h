...
#elif SERVER
#define ATT_VALUE_ARRAY_SIZE    (44 + 80 + 492 * 2) //(GATT + GAP) = 44 + Chat  (TX (41) + RX (39) characteristics)   Services
#endif
...
#define MAX_ATT_MTU             (247)  /* Optimized value for best throughput performances */

/* Set the number of prepare write request needed to write an att of 512 bytes,
   using MTU default value (23 bytes) */
#define PREPARE_WRITE_LIST_SIZE (0)

#define OPT_MBLOCKS             (10 * 7)
