#ifndef _HID_STACK_CONFIG_H_
#define _HID_STACK_CONFIG_H_
...
#define NUM_APP_GATT_SERVICES 4

/* Number of attributes requests from the HID demo */
#define NUM_APP_GATT_ATTRIBUTES 40
...
#define HID_MAX_ATT_SIZE        (66)  /* HID_REPORT_MAP_CHARAC len = 66 */
#endif 
#endif 
...
#define MAX_ATT_SIZE            (HID_MAX_ATT_SIZE)  
