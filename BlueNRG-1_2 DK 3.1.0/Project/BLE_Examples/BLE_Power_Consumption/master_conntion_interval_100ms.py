...
Status= ACI_GAP_CREATE_CONNECTION(LE_Scan_Interval=0x4000,LE_Scan_Window=0x4000,Peer_Address_Type=0x00,Peer_Address=0x0280E100ECBC,Own_Address_Type=0x00,Conn_Interval_Min=0x0050,Conn_Interval_Max=0x0050,Conn_Latency=0x0000,Supervision_Timeout=0x03E8,Minimum_CE_Length=0x0000,Maximum_CE_Length=0x03E8)
if Status!=0x00:
