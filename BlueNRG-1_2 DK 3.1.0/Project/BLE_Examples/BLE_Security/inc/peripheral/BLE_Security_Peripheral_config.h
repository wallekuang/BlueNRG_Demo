#ifndef _SECURITY_PERIPHERAL_CONFIG_H_
#define _SECURITY_PERIPHERAL_CONFIG_H_
...
/* Number of services requests from the demo */
#define NUM_APP_GATT_SERVICES 1  /* 1 service */

/* Number of attributes requests from the demo */
#define NUM_APP_GATT_ATTRIBUTES 5 /* 5 attributes x BLE Security Peripheral service characteristics */
...
#define ATT_VALUE_ARRAY_SIZE    (36  + 14 + 80) //[(GATT + GAP) = 36 +  14 (DEVICE NAME: 'S','L','A','V','E','_','S','E','C','U','R','I','T','Y' (14 bytes)]  + TX (41) + RX (39) characteristics   Services
...
#endif // _SECURITY_PERIPHERAL_CONFIG_H_
