...
/* Number of GATT services needed for the central demo. */
#define NUM_GATT_SERVICES       (DEFAULT_NUM_GATT_SERVICES + NUM_APP_GATT_SERVICES)

/* Array size for the attribute value */
#define ATT_VALUE_ARRAY_SIZE    (36 + 15) //(GATT + GAP) = 36 + 15 (Device Name = 'M','A','S','T','E','R','_','S','E','C','U','R','I','T','Y' (15 bytes))
